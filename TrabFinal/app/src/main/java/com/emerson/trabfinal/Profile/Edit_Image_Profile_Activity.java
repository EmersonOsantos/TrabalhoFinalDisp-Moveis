package com.emerson.trabfinal.Profile;
...
public class Edit_Image_Profile_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Selecionar Image");
...
//                Toast.makeText(Edit_Image_Profile_Activity.this, "Chose image", Toast.LENGTH_SHORT).show();
        ...
        BtnUpdateImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (imageUri == null){
                    Toast.makeText(Edit_Image_Profile_Activity.this, "Inserir nova image", Toast.LENGTH_SHORT).show();
                }else {
        ...
        databaseReference.child(user.getUid())
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(Edit_Image_Profile_Activity.this, "Imagem atualizada", Toast.LENGTH_SHORT).show();
                        onBackPressed();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
...
//                        SET IMAGE SELECTED ON IV
                        ...
                        Toast.makeText(Edit_Image_Profile_Activity.this, "Cancelado pelo usuario", Toast.LENGTH_SHORT).show();
                    }
                }
            }
    );
