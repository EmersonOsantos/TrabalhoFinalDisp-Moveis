...
public class Update_Contact_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Editar contato");
        ...
        Btn_Accept_phone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!phone.equals("")){
                    ...
                    Toast.makeText(Update_Contact_Activity.this, "Numero adicionado", Toast.LENGTH_SHORT).show();
                    dialog_Establish_phone.dismiss();
                }
            }
        });
    ...
    private void Update_Contact_Info() {
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Toast.makeText(Update_Contact_Activity.this, "informação atualizada", Toast.LENGTH_SHORT).show();
            }
    ...
    private void UploadImageStorage() {
        progressDialog.setMessage("Subindo imagem");
        progressDialog.show();
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    if (result.getResultCode() == Activity.RESULT_OK){
                        ...
                        Toast.makeText(Update_Contact_Activity.this, "Cancelado pelo usuario", Toast.LENGTH_SHORT).show();
                    }
                }
            }
    );
