        ...
        firebaseAuth.createUserWithEmailAndPassword(gmail, password)
                .addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                    ...
                    public void onSuccess(AuthResult authResult) {
                        //
                        SaveInformation();
                        Toast.makeText(RecordActivity.this, "Conta criada", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(RecordActivity.this, LoginActivity.class));
                        finish();
                    }
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(RecordActivity.this, "erro " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }

    private void SaveInformation() {
        progressDialog.setMessage("Salvando sua informação");
        progressDialog.dismiss();
