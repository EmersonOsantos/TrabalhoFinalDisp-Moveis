...
import com.emerson.trabfinal.ViewHolder.ViewHolder_Important_Note;
...
public class Important_Notes_Activity extends AppCompatActivity {
    ...
    private void CheckUser() {
        if (user == null) {
            Toast.makeText(Important_Notes_Activity.this, "Ocorreu um erro", Toast.LENGTH_SHORT).show();
        }else {
            ListImportantNotes();
        }
    }
...
//                                Toast.makeText(Important_Notes_Activity.this, "Deleted note", Toast.LENGTH_SHORT).show();
                        ...
                        DeleteNoteCancel.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Toast.makeText(Important_Notes_Activity.this, "Operacão cancelada pelo usuario", Toast.LENGTH_SHORT).show();
                                dialog.dismiss();
                            }
                        });
            ...
            reference.child(Objects.requireNonNull(firebaseAuth.getUid())).child("Important Notes").child(id_note)
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void unused) {
                            Toast.makeText(Important_Notes_Activity.this, "Observe que não é mais importante", Toast.LENGTH_SHORT).show();
                        }
