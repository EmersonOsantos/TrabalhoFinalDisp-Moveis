...
import com.emerson.trabfinal.Configuration.Configuration_Activity;
import com.emerson.trabfinal.Notes.Add_Note_Activity;
import com.emerson.trabfinal.Contacts.List_Contacts_Activity;
import com.emerson.trabfinal.Notes.Important_Notes_Activity;
import com.emerson.trabfinal.Notes.List_Notes_Activity;
...
//                Toast.makeText(MainMenuActivity.this, "Contacts", Toast.LENGTH_SHORT).show();
    ...
    private void VerifyEmailAccount() {
        ...
        builder.setTitle("Verificar conta")
                .setMessage("Pressione confirmar para enviar um e-mail de confirmação para o seu Gmail"
                +user.getEmail())
                ...
                .setNegativeButton("Cancelar", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(MainMenuActivity.this, "Operação cancelada", Toast.LENGTH_SHORT).show();
                    }
                }).show();
    }

    private void SendMailForVerification() {
        progressDialog.setMessage("enviando confirmação para sua caixa de entrada "+ user.getEmail());
        progressDialog.show();
        ...
        user.sendEmailVerification()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(MainMenuActivity.this, "Verifique sua caixa de entrada "+ user.getEmail(), Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        //FAILED CONFIRMATION
                        Toast.makeText(MainMenuActivity.this, "Ocorreu um erro: "+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void Information() {
        ...
        facebook.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent Pfacebook = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.facebook.com"));
        ...
        instagram.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent Pinstagram = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.instagram.com"));
