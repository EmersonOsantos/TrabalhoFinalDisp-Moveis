...
public class Detail_Note_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("detalhes de notas");
    ...
    private void Add_Important_Notes() {
        if (user == null){
            //IF USER IS NULL
            Toast.makeText(Detail_Note_Activity.this, "ocorreu um erro", Toast.LENGTH_SHORT).show();
        }else {
            ...
            reference.child(Objects.requireNonNull(firebaseAuth.getUid())).child("Important Notes").child(id_note_R)
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void unused) {
                            Toast.makeText(Detail_Note_Activity.this, "Adicionada como importante", Toast.LENGTH_SHORT).show();
                        }
