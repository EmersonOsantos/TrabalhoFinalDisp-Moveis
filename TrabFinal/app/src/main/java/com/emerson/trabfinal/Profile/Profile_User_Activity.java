...
import com.emerson.trabfinal.UpdatePassword.Update_Password_Activity;
...
//                    GET DATA
                    ...
                    Toast.makeText(Profile_User_Activity.this, "Aguardando dados", Toast.LENGTH_SHORT).show();
                }
            }
        ...
        Btn_Accept_phone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!phone.equals("")){
                    ...
                    Toast.makeText(Profile_User_Activity.this, "Add numero", Toast.LENGTH_SHORT).show();
                    dialog_Establish_phone.dismiss();
                }
            }
        });
        ...
        Users.child(user.getUid()).updateChildren(update_data)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(Profile_User_Activity.this, "sucesso", Toast.LENGTH_SHORT).show();
                    }
