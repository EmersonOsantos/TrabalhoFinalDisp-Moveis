package com.emerson.trabfinal.UpdatePassword;
...
import com.emerson.trabfinal.LoginActivity;
...
public class Update_Password_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Alterar senha");
        ...
        Btn_update_password.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Actual_password.equals("")) {
                    ...
                    Toast.makeText(Update_Password_Activity.this, "As senhas não coincidem", Toast.LENGTH_SHORT).show();
                } else if (New_Password.length() < 6) {
                    ETNewPassword.setError("A senha deve ser maior ou igual a 6 caracteres");
                } else {
    ...
    private void Update_Password(String actualPassword, String newPassword) {
        ...
        user.reauthenticate(authCredential)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void unused) {
                                        ...
                                        DB_Users.child(user.getUid()).updateChildren(hashMap)
                                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                    @Override
                                                    public void onSuccess(Void unused) {
                                                        Toast.makeText(Update_Password_Activity.this, "Mudanças aplicadas", Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        progressDialog.dismiss();
                        Toast.makeText(Update_Password_Activity.this, "A senha está errada", Toast.LENGTH_SHORT).show();
                    }
                });
    }
